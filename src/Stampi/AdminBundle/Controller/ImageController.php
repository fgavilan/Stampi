...
use Stampi\AdminBundle\Entity\Image;
use Stampi\AdminBundle\Form\ImageType;
...
class ImageController extends Controller
{
    ...
    public function indexAction()
    {
        ...
        $entities = $em->getRepository('StampiAdminBundle:Image')->findAll();

        return $this->render('StampiAdminBundle:Image:index.html.twig', array(
            'entities' => $entities,
        ));
    }
    /**
    ...
    public function createAction(Request $request)
    {
        ...
        return $this->render('StampiAdminBundle:Image:new.html.twig', array(
            'entity' => $entity,
    ...
    public function showAction($id)
    {
        ...
        $entity = $em->getRepository('StampiAdminBundle:Image')->find($id);
        ...
        return $this->render('StampiAdminBundle:Image:show.html.twig', array(
            'entity'      => $entity,
    ...
    public function editAction($id)
    {
        ...
        return $this->render('StampiAdminBundle:Image:edit.html.twig', array(
            'entity'      => $entity,
