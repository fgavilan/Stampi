...
class ImageController extends Controller
{
    ...
    public function indexAction()
    {
        ...
        $entities = $em->getRepository('MediaBundle:Image')->findAll();
    ...
    public function createAction(Request $request)
    {
        ...
        return $this->render('MediaBundle:Image:new.html.twig', array(
            'entity' => $entity,
    ...
    public function showAction($id)
    {
        ...
        $entity = $em->getRepository('MediaBundle:Image')->find($id);
        ...
        return $this->render('MediaBundle:Image:show.html.twig', array(
            'entity'      => $entity,
    ...
    public function editAction($id)
    {
        ...
        return $this->render('MediaBundle:Image:edit.html.twig', array(
            'entity'      => $entity,
